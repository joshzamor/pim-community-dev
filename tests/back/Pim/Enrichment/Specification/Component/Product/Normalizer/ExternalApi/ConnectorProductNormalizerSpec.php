...
class ConnectorProductNormalizerSpec extends ObjectBehavior
{
    ...
    function it_normalizes_a_list_of_products(FillMissingValuesInterface $fillMissingValues)
    {
        ...
        $fillMissingValues->fromStandardFormat($normalizedProduct1)->willReturn($normalizedProduct1);
        ...
        $fillMissingValues->fromStandardFormat($normalizedProduct2)->willReturn($normalizedProduct2);

        $this->normalizeConnectorProductList(new ConnectorProductList(1, [$connector1, $connector2]))
            ->shouldBeLike([$normalizedProduct1, $normalizedProduct2]);
    }
}
